...
##############################################
server_name="ManageServer"
server_name_id="ManageServer"
...
javaParam="-XX:+HeapDumpOnOutOfMemoryError -Xmx200m -Xms50m -Xss256k"
javaDebug=""
if [ "$debug_port" != "" ] ;then
...
javaMain="nicehu.server.manageserver.Main"
##############################################
