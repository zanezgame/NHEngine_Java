...
public class CreateAccountHandler extends LogicHandler
{
	...
	{
		CreateAccountReq request = (CreateAccountReq)msg.getPb(CreateAccountReq.getDefaultInstance());
		logger.info("recv CreateAccountHandler, account: " + request.getAccount() + " pass: " + request.getPass());
