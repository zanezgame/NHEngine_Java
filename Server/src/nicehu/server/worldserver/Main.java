...
import nicehu.server.worldserver.core.WorldHandlerRegister;
...
public class Main
{
	...
	private static int serverType = ServerType.WORLD;
	private static String serverName = "WorldServer_001";
