...
public class QueryPlayerReqHandler extends LogicHandler
{
	private static final Logger logger = LoggerFactory.getLogger(QueryPlayerReqHandler.class);

	@Override
	public void handle(GameSession session, Message msg)
	{
		QueryPlayerReq request = (QueryPlayerReq)msg.getPb(QueryPlayerReq.getDefaultInstance());
