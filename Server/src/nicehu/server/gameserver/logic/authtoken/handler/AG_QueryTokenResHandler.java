...
public class AG_QueryTokenResHandler extends LogicHandler
{

	private static final Logger logger = LoggerFactory.getLogger(AG_QueryTokenResHandler.class);

	@Override
	public void handle(ServerNode sender, Message msg)
	{

		QueryTokenRes request = (QueryTokenRes)msg.getProtoBuf();
		logger.info("recv QueryTokenRes from authServer playerId:" + msg.playerId);
