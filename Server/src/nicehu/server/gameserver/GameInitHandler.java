...
public class GameInitHandler extends ServerInitHandler
{
	private static final Logger logger = LoggerFactory.getLogger(GameInitHandler.class);

	@Override
	public void processServerLoginRes(ServerNode sender, int result, int serverId, String serverConfigStr, List<StreamObject> serverStreamObjects,
	...
	{
		logger.warn("GameServer connectTo " + serverInfo.getName() + " ServerId: " + Integer.toHexString(serverInfo.getId()) + " ip: " + serverInfo.getIpForServer()
