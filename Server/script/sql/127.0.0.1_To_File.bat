...
mysqldump -h127.0.0.1 -uroot -proot --default-character-set=utf8 --comments=TRUE --no-data=TRUE --create-options=TRUE --add-drop-database=TRUE --add-drop-table=TRUE --databases wind_gm  > ./wind_gm.sql
